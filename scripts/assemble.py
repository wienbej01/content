...
# S13-T003: Import audio_assembly_mode mapping for hero island assembly
try:
    from assemble_db import get_audio_assembly_mode
except ImportError:
    # Fallback for test environments where assemble_db may not be available
    get_audio_assembly_mode = None
...
def assemble_format(manifest, fmt, speeds, base, tmp, allow_looping=False):
    ...
    if manifest.get("narration_mode") == "continuous_voiceover":
        ...
        # S13-T003: Audio-island assembly for hero lip sync
