...
STAGE_REGISTRY: dict[str, StageDefinition] = {
    ...
    "word_alignment":    StageDefinition("word_alignment", depends_on=["tts"], produces_kinds=["word_timing"], consumes_kinds=["script", "tts_artifact"]),
    "audio_timing":      StageDefinition("audio_timing", depends_on=["word_alignment"], produces_kinds=["timing_map"], consumes_kinds=["tts_artifact", "storyboard"]),
